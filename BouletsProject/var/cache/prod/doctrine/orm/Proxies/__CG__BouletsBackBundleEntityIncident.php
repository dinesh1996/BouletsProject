 ...
 */
class Incident extends \Boulets\BackBundle\Entity\Incident implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'id', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'nom', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'type', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'text', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'machine', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'datedebut', '' . "\0" . 'Boulets\\BackBundle\\Entity\\Incident' . "\0" . 'datefin'];
        }
